...
import speedNorth from './../assets/svg-icons/speed_north.svg';
import speedArrow from './../assets/svg-icons/speed_arrow.svg';
...
export default {
  ...
  'north-speed': speedNorth,
  'speed-arrow': speedArrow, 
